...
struct parseconf_uint_setting parseconf_uint_array[] =
{
    ...
    {"accept_tineout", &tunable_accept_tineout},
    {"connect_tineout", &tunable_connect_tineout},
    {"idle_session_tineout", &tunable_idle_session_tineout},
    {"data_connection_tineout", &tunable_data_connection_tineout},
